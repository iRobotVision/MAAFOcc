...
class BEVFusion(Base3DFusionModel):
    ...
    def forward_single(
        ...
        **kwargs,
        ...
        # modules_with_names = [
        #     ("camera_backbone", self.encoders["camera"]["backbone"]),
        #     ("camera_neck", self.encoders["camera"]["neck"]),
        #     ("camera_vtransform", self.encoders["camera"]["vtransform"]),
        #     ("lidar_backbone", self.encoders["lidar"]["backbone"]),
        #     ("fuser", self.fuser),
        #     ("decoder_backbone", self.decoder["backbone"]),
        #     ("decoder_neck", self.decoder["neck"]),
        #     ("heads", self.heads)
        # ]
        ...
        # for name, module in modules_with_names:
        #     if module is None:
        ...
        #         print(f"{name}: {mod_params / 1e6:.2f}M")
